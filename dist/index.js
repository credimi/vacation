...
exports.toDateStr = exports.vacations = exports.holidays = exports.closestWorkingDay = exports.getLastWorkDayOfMonth = exports.isVacation = void 0;
...
Object.defineProperty(exports, "vacations", { enumerable: true, get: function () { return vacations_1.vacations; } });
var defaultOptions = {
    withVacations: true,
    withHolidays: true,
...
var checkDateFormat = function (date) {
    if (checkValidDateStr(date)) {
        ...
        throw new Error("Invalid date string: ".concat(date));
    }
};
var toDateStr = function (date) {
    if (typeof date === 'string') {
        ...
        var tzDate = new Date(Date.UTC(date.getFullYear(), date.getMonth(), date.getDate()));
...
var isVacancy = function (date, proposedOptions) {
    ...
    var _a = __assign(__assign({}, defaultOptions), proposedOptions), withWeekends = _a.withWeekends, withVacations = _a.withVacations, withHolidays = _a.withHolidays;
...
var closestWorkingDay = function (date, options) {
    checkDateFormat(date);
...
exports.closestWorkingDay = closestWorkingDay;
